...
public class REGULARTIME {
    ...
    @Expose
    private List<DateTimeEntriesList> dateTimeEntriesList = null;
    ...
    public List<DateTimeEntriesList> getDateTimeEntriesList() {
        return dateTimeEntriesList;
    }

    public void setDateTimeEntriesList(List<DateTimeEntriesList> dateTimeEntriesList) {
