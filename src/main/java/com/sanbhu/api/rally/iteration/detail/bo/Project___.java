...
public class Project___ {
    ...
    public Children____ getChildren() {
        return children;
    }

    public void setChildren(Children____ children) {
    ...
    public void setOwner(Owner_____ owner) {
        this.owner = owner;
    }
